...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = com.example.hw04_gymlog_v300.databinding.ActivityMainBinding.inflate(getLayoutInflater());
    ...
    private void getInformationFromDisplay(){
        ...
        try {
            ...
            Log.d("SEC_GYMLOG", "Error reading value from Weight edit text.");
        }
        ...
        try {
            ...
            Log.d("SEC_GYMLOG", "Error reading value from Reps edit text.");
        }
